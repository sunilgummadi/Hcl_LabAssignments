...
INSERT INTO Account_Master VALUES(335416797144,'2019-05-23','9177887377');
INSERT INTO Account_Master VALUES(525416897045,'2019-07-13','8341414502');
INSERT INTO Account_Master VALUES(324446897142,'2020-11-23','7995039932');

SELECT cm.customer_first_name FROM Customer_Master cm INNER JOIN Account_Master am 
ON cm.customer_number = am.customer_number GROUP BY cm.customer_first_name
HAVING COUNT(cm.customer_number)>=2 ORDER BY customer_first_name;

--prints Sunil Kumar and Surya